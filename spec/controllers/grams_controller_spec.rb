...
RSpec.describe GramsController, type: :controller do
  ...
  describe 'grams#create action' do
    ...
    it 'should successfully create a new gram in db and redirect to root' do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe 'grams#edit' do
    it 'should not let a user who did not create the gram edit one' do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
    ...
    it 'should return a 404 error message if gram is not found' do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe 'grams#update action' do
    ...
    it 'should not let unauthenticated update a gram' do
      gram = FactoryGirl.create(:gram)
    ...
    it 'should update render the edit form with http status of unprocessable_entity' do
      gram = FactoryGirl.create(:gram, message: 'Initial Value')
      sign_in gram.user
  ...
  describe 'grams#destroy action' do
    it 'should not let a user who did not create the gram destroy it' do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe 'comments#create action' do
    ...
    it 'should require a user to be logged in to comment on a gram' do
      ...
      expect(response).to redirect_to new_user_session_path
      expect(gram.message.length).to eq 0
    end
